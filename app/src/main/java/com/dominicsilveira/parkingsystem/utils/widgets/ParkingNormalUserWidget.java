...
public class ParkingNormalUserWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        PendingIntent mapsPendingIntent = PendingIntent.getActivity(context, 1000, mapsIntent, PendingIntent.FLAG_IMMUTABLE);

        Intent nearByIntent=new Intent(context, SplashScreen.class);
        nearByIntent.putExtra("ACTIVITY_NO", 32);
        PendingIntent nearByPendingIntent = PendingIntent.getActivity(context, 1001, nearByIntent, PendingIntent.FLAG_IMMUTABLE);

        Intent historyIntent=new Intent(context, SplashScreen.class);
        historyIntent.putExtra("ACTIVITY_NO", 33);
        PendingIntent historyPendingIntent = PendingIntent.getActivity(context, 1002, historyIntent, PendingIntent.FLAG_IMMUTABLE);
